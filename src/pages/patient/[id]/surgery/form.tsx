...
import React, { FC, useEffect, useRef, useState, ChangeEvent, forwardRef, useImperativeHandle } from 'react';
...
const SurgeryForm = forwardRef<DynamicFormHandle, SurgeryProps>(
// const SurgeryForm: React.FC<SurgeryProps> = 

  ({formLabels, editID, show, mode, procedureList, formCurData, 
  handleClose, refreshForm, createPurchaser, deleteProcedure, handleTypeaheadInputChange, handleInputChange, 
  formReset, handleSave
  }, ref) => {
